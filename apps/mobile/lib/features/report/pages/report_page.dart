...
class _IncidentPhotoPicker extends StatelessWidget {
  const _IncidentPhotoPicker({
    required this.image,
    required this.enabled,
    required this.onTap,
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      image == null ? 'Add Photo' : 'Photo Selected',
                    ...
                    Text(
                      image == null
                          ? 'Optional • Take a photo or choose from gallery'
                          : image!.name,
                      maxLines: 1,
