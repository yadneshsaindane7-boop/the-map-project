/*
=========================================================
The Map Project — Migration 01
File: 01_dynamic_routing_integration.sql
Purpose:
  1. Extend submit_incident_report() to accept osm_way_id
     with backwards-compatible 6-parameter overload.
  2. Extend approve_incident_report() to:
     - Validate osm_way_id IS NOT NULL before creating road_events
     - Insert road_event_segments with appropriate closure/penalty
     - Atomically update incident status, event_history, and audit_logs
  3. Create v_active_routing_segments view for dynamic routing.
=========================================================
*/

-- =========================================================
-- 1. SUBMIT INCIDENT REPORT (7 parameters: includes osm_way_id)
-- =========================================================
...
-- =========================================================
-- 1B. SUBMIT INCIDENT REPORT (6 parameters: backwards compatibility)
-- =========================================================
...
BEGIN
    ...
    Current NashikRoadGraph edge cost is: travel_time + penalty.
    These documented defaults represent initial application estimates:
      - Road Closure: is_closed = TRUE,  weight_modifier = 0
      - Flood:        is_closed = TRUE,  weight_modifier = 0
      - Accident:     is_closed = FALSE, weight_modifier = 900 (15 min delay)
      - Construction: is_closed = FALSE, weight_modifier = 300 (5 min delay)
      - Diversion:    is_closed = FALSE, weight_modifier = 180 (3 min delay)
      - Pothole:      is_closed = FALSE, weight_modifier = 60  (1 min delay)
    ---------------------------------------------------------
    */
